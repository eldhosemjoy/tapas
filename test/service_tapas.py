...
tapas_service_url = "http://localhost:5000/tapas_predictor"

request_json = {
    "question"  : "what was the position of the Patrick Carpentier?",
    "table"     :   [
...
tapas_request = requests.post(tapas_service_url, data=payload)

tapas_request_response = json.loads(tapas_request.text)

print(tapas_request_response)